...
import csv
import util
from library.GPR.FileProcess_GPR_S3S4 import Record, RecordPDF
...
class Test:
    ...
    def compareResult(self, record):
        ...
        with open('../../standard/GPR/standard_GPR_S3S4.csv', 'r', encoding='utf-8') as csv_file:
...
class Execute:
    ...
    def run(self, input_path):
        ...
        for file in files_to_process:
            ...
            count = count + 1
            print("测试完成GPR_S3S4 Word文件" + file)
...
if __name__ == "__main__":
    inputpath = r"E:/STUDY/IS3/数据提取文件/数据提取文件示例/源数据/GPR地质预报/S3-S4标数据"
    a = Execute()
    a.run(inputpath)
